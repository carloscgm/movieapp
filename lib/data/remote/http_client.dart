...
import 'package:movieapp/data/remote/interceptor/dio_logging_interceptor.dart';
import 'package:movieapp/data/remote/network_endpoints.dart';

import 'credentials_wallet.dart';

class HttpClient {
  final Dio dio = Dio(BaseOptions(queryParameters: {
    'language': 'es-ES'
  }, headers: {
    'Authorization': 'Bearer ${NetworkEndpoints.Bearer_token}',
  }));
